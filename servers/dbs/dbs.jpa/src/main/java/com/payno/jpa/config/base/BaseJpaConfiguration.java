...
@EntityScan(
        basePackages = {BaseJpaProperties.BASE_PACKAGE,"com.payno.jpa.querydsl","com.payno.jpa.demo"}
)
@EnableJpaRepositories(
        basePackages = {BaseJpaProperties.BASE_PACKAGE,"com.payno.jpa.querydsl"})
